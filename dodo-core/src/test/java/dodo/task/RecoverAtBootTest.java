...
public class RecoverAtBootTest extends BasicBrokerEnv {
    ...
    static final int taskType1 = 10023;
    static final int taskType2 = 10024;
    ...
    protected StatusChangesLog createStatusChangesLog() {
        ...
        return new MemoryCommitLog(Arrays.asList(
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber1), StatusEdit.ADD_TASK(taskId1, taskType1, "param", userid1,0)),
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber2), StatusEdit.ADD_TASK(taskId2, taskType2, "param", userid1,0)),
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber3), StatusEdit.ADD_TASK(taskId3, taskType2, "param", userid1,0)),
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber4), StatusEdit.ADD_TASK(taskId4, taskType2, "param", userid1,0)),
