...
public class RecoverAtBootTest extends BasicBrokerEnv {
    ...
    protected StatusChangesLog createStatusChangesLog() {
        ...
        return new MemoryCommitLog(Arrays.asList(
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber1), StatusEdit.ADD_TASK(taskId1, taskType1, "param", userid1)),
                ...
                new MemoryCommitLog.MemoryLogLine(new LogSequenceNumber(0, sequenceNumber6), StatusEdit.TASK_STATUS_CHANGE(taskId4, worker1, Task.STATUS_FINISHED, "ok!"))
