...
public class BrokerHostData {
    ...
    public BrokerHostData(String host, int port, String version, boolean ssl, Map<String, String> additionalData) {
        this.port = port;
        this.host = host;
    ...
    public static byte[] formatHostdata(BrokerHostData data) {
        try {
    ...
    public static BrokerHostData parseHostdata(byte[] oo) {
        try {
            ...
            return new BrokerHostData(host, port, version, ssl, additional);
        } catch (IOException impossible) {
            throw new RuntimeException(impossible);
        }
    }
