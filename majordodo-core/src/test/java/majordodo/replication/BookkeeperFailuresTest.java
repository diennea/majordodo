...
public class BookkeeperFailuresTest extends BrokerTestUtils {
    ...
    // To be replaced with the same one method of BrokerTestUtils
    private static void waitForBrokerToBecomeLeader(Broker broker, long waitTime) throws InterruptedException {
    ...
    public void fencingTest() throws Exception {
        ...
        long taskId1 = broker1.getClient().submitTask(new AddTaskRequest(0, TASKTYPE_MYTYPE, userId, taskParams, 1, 0, null, 0, null, null)).getTaskId();
        long taskId2 = broker1.getClient().submitTask(new AddTaskRequest(0, TASKTYPE_MYTYPE, userId, taskParams, 1, 0, null, 0, null, null)).getTaskId();
        
        try {
            long taskId3 = broker2.getClient().submitTask(new AddTaskRequest(0, TASKTYPE_MYTYPE, userId, taskParams, 1, 0, null, 0, null, null)).getTaskId();
            fail();
        } catch (Exception ex) {
        ...
        try (BookKeeper bk = createBookKeeper();) {
            try (LedgerHandle fenceLedger = bk.openLedger(
                ...
                try {
                    long taskId4 = broker1.getClient().submitTask(new AddTaskRequest(0, TASKTYPE_MYTYPE, userId, taskParams, 1, 0, null, 0, null, null)).getTaskId();
                    fail();
        ...
        long taskId5 = broker2.getClient().submitTask(new AddTaskRequest(0, TASKTYPE_MYTYPE, userId, taskParams, 1, 0, null, 0, null, null)).getTaskId();
