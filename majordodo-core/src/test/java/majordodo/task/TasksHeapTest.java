...
public class TasksHeapTest {
    ...
    public void test1() throws Exception {
        ...
        List<AssignedTask> taskids = instance.takeTasks(1, Arrays.asList(Task.GROUP_ANY), Collections.emptySet(), availableSpace, Collections.emptyMap(), new ResourceUsageCounters(), Collections.emptyMap(), new ResourceUsageCounters(), null, 0);
    ...
    public void test3() throws Exception {
        ...
        AtomicLong newTaskId = new AtomicLong(987);
        instance.insertTask(newTaskId.incrementAndGet(), TASKTYPE_MYTASK1, USERID1);
        List<AssignedTask> taskids = instance.takeTasks(1, Arrays.asList(GROUPID1), Collections.emptySet(), availableSpace, Collections.emptyMap(), new ResourceUsageCounters(), Collections.emptyMap(), new ResourceUsageCounters(), null, 0);
        assertEquals(1, taskids.size());
        assertEquals(newTaskId.get(), taskids.get(0).taskid);
    }
    ...
    public void test5() throws Exception {
        ...
        {
            List<AssignedTask> taskids = instance.takeTasks(2, Arrays.asList(GROUPID1), Collections.emptySet(), availableSpace, Collections.emptyMap(), new ResourceUsageCounters(), Collections.emptyMap(), new ResourceUsageCounters(), null, 0);
    ...
    public void testExcelude() throws Exception {
        ...
        {
            List<AssignedTask> taskids = instance.takeTasks(3, Arrays.asList(Task.GROUP_ANY), new HashSet<>(Arrays.asList(GROUPID1)), availableSpace, Collections.emptyMap(), new ResourceUsageCounters(), Collections.emptyMap(), new ResourceUsageCounters(), null, 0);
            assertEquals(1, taskids.size());
            assertEquals(task3, taskids.get(0).taskid);
        }
